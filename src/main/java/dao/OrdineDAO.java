        ...
        try (
            ...
            try (ResultSet risultato = statement.executeQuery()) {
                while (risultato.next()) {
                    ...
                    dettaglio.setTitoloProdotto(risultato.getString("titolo_prodotto"));
