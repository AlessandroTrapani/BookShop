...
<head>
    <meta charset="UTF-8">
    <title>Dettaglio ordine admin - BookShop</title>
...
<body>
    ...
    <main class="contenitore contenuto-pagina">
        ...
        %>
            ...
            <form method="post" action="${pageContext.request.contextPath}/admin/aggiorna-stato-ordine">
            ...
            <table class="tabella-carrello">
                ...
                <tbody>
                    ...
                    %>
                        ...
                        <tr>
                            <td><%= dettaglio.getTitoloProdotto() %></td>
